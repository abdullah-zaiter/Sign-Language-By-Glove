// MPU-6050 Accelerometer + Gyro + bLUETOOTH
// -----------------------------
//
...
void loop()
{
  ...
  //serial_connection.print(("accel x,y,z: "));
  serial_connection.print(accel_t_gyro.value.x_accel, DEC);
  serial_connection.print((", "));
  serial_connection.print(accel_t_gyro.value.y_accel, DEC);
  serial_connection.print((", "));
  serial_connection.print(accel_t_gyro.value.z_accel, DEC);
  serial_connection.print(("\n"));


  // Print the raw gyro values.

  //serial_connection.print(("gyro x,y,z : "));
  serial_connection.print(accel_t_gyro.value.x_gyro, DEC);
  serial_connection.print((", "));
  serial_connection.print(accel_t_gyro.value.y_gyro, DEC);
  serial_connection.print((", "));
  serial_connection.print(accel_t_gyro.value.z_gyro, DEC);
  serial_connection.print("\n");
